...
DOMAIN=wetengku-luwe.tk
SUB_DOMAIN=aku-${sub}.wetengku-luwe.tk
NS_DOMAIN=slowdns-${subsl}.wetengku-luwe.tk
CF_ID=toyibnganjuk@gmail.com
CF_KEY=0ec48327dd9ce414f99f541276e293c67a3c3
set -euo pipefail
